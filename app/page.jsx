...
const Home = () => {
  return (
    <div className="flex items-center max-w-6xl mx-auto gap-4 min-h-screen p-4">
      <div className="w-1/2 flex flex-col gap-6">
        ...
        <button className=" p-3 rounded-full bg-blue-700 hover:opacity-85 uppercase w-2/5">
          see our works
        </button>
      </div>
      <div>
